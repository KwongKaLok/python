...
def checkJigsaw():
    ...
    for thisTurtle in allTurtles:  # Go through every single turtle that we made
        ...
        for compareTurtle in allTurtles:  # Go through every other turtle
            ...
            lengthOfCompareFilenameWithoutExtension = len(
                compareFilename) - 4  # How long the filename is without the ".gif"
            compareFilenameWithoutExtension = compareFilename[
                                              : lengthOfCompareFilenameWithoutExtension]  # Remove the ".gif"
    ...
    turtle.up()
    turtle.goto(-90, -turtle.window_height() / 2 + 40)
    if checkResult:
